"""
bulk_import_exams.py
--------------------
Walk frontend/public/pdfs/exams/fr/ and import all exam PDFs into MongoDB GridFS.

Usage:
    cd backend
    python bulk_import_exams.py

Folder structure expected:
    exams/fr/{specialty}/{subject}/{semester}/{chapter}/{file}.pdf
"""
...
PDFS_ROOT = os.path.join(
    os.path.dirname(__file__), "..", "frontend", "public", "pdfs", "exams", "fr"
)
    ...
    for dirpath, dirnames, filenames in os.walk(pdfs_root):
        for filename in filenames:
            ...
            try:
                ...
                uploaded += 1
                print(f"  OK  exams/{specialty}/{subject}/{semester}/{chapter}/{filename}")
